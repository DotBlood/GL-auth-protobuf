...
type RegisterResponse struct {
	...
	//
	//	*RegisterResponse_JwtToken
	//	*RegisterResponse_ErrorData
...
func (x *RegisterResponse) GetJwtToken() string {
	if x, ok := x.GetResponse().(*RegisterResponse_JwtToken); ok {
		return x.JwtToken
	}
	return ""
}

func (x *RegisterResponse) GetErrorData() []byte {
	if x, ok := x.GetResponse().(*RegisterResponse_ErrorData); ok {
		return x.ErrorData
	}
	return nil
}
...
type RegisterResponse_JwtToken struct {
	JwtToken string `protobuf:"bytes,1,opt,name=jwt_token,json=jwtToken,proto3,oneof"`
}

type RegisterResponse_ErrorData struct {
	ErrorData []byte `protobuf:"bytes,2,opt,name=error_data,json=errorData,proto3,oneof"`
}

func (*RegisterResponse_JwtToken) isRegisterResponse_Response() {}

func (*RegisterResponse_ErrorData) isRegisterResponse_Response() {}
...
type LoginResponse struct {
	...
	// Types that are assignable to Response:
	//
	//	*LoginResponse_JwtToken
	//	*LoginResponse_ErrorData
...
func (x *LoginResponse) GetJwtToken() string {
	if x, ok := x.GetResponse().(*LoginResponse_JwtToken); ok {
		return x.JwtToken
	}
	return ""
}

func (x *LoginResponse) GetErrorData() []byte {
	if x, ok := x.GetResponse().(*LoginResponse_ErrorData); ok {
		return x.ErrorData
	}
	return nil
}
...
type LoginResponse_JwtToken struct {
	JwtToken string `protobuf:"bytes,1,opt,name=jwt_token,json=jwtToken,proto3,oneof"`
}

type LoginResponse_ErrorData struct {
	ErrorData []byte `protobuf:"bytes,2,opt,name=error_data,json=errorData,proto3,oneof"`
}

func (*LoginResponse_JwtToken) isLoginResponse_Response() {}

func (*LoginResponse_ErrorData) isLoginResponse_Response() {}
...
func (x *RecoverRequest) GetOldPassword() string {
	if x != nil {
...
func (x *RecoverRequest) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
type RecoverResponse struct {
	...
	// Types that are assignable to Response:
	//
	//	*RecoverResponse_Sucess
	//	*RecoverResponse_ErrorData
	Response isRecoverResponse_Response `protobuf_oneof:"response"`
}
...
func (m *RecoverResponse) GetResponse() isRecoverResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *RecoverResponse) GetSucess() bool {
	if x, ok := x.GetResponse().(*RecoverResponse_Sucess); ok {
		return x.Sucess
	}
	return false
}

func (x *RecoverResponse) GetErrorData() []byte {
	if x, ok := x.GetResponse().(*RecoverResponse_ErrorData); ok {
		return x.ErrorData
	}
	return nil
}

type isRecoverResponse_Response interface {
	isRecoverResponse_Response()
}

type RecoverResponse_Sucess struct {
	Sucess bool `protobuf:"varint,1,opt,name=sucess,proto3,oneof"`
}

type RecoverResponse_ErrorData struct {
	ErrorData []byte `protobuf:"bytes,2,opt,name=error_data,json=errorData,proto3,oneof"`
}

func (*RecoverResponse_Sucess) isRecoverResponse_Response() {}

func (*RecoverResponse_ErrorData) isRecoverResponse_Response() {}
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x76, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x5e, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x09, 0x6a, 0x77, 0x74, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x08, 0x6a, 0x77, 0x74, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x12, 0x1f, 0x0a, 0x0a, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x09, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x44,
	...
	0x05, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x22, 0x5b, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69,
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x09, 0x6a, 0x77, 0x74,
	0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x08,
	0x6a, 0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1f, 0x0a, 0x0a, 0x65, 0x72, 0x72, 0x6f,
	0x72, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x09,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x61, 0x74, 0x61, 0x42, 0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x60, 0x0a, 0x0e, 0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72,
	...
	,
	...
	,
...
var file_auth_auth_proto_goTypes = []interface{}{
	...
	(*RecoverRequest)(nil),   // 4: auth.RecoverRequest
	(*RecoverResponse)(nil),  // 5: auth.RecoverResponse
...
var file_auth_auth_proto_depIdxs = []int32{
	...
	4, // 2: auth.AuthService.Recover:input_type -> auth.RecoverRequest
	...
	5, // 6: auth.AuthService.Recover:output_type -> auth.RecoverResponse
...
func file_auth_auth_proto_init() {
	...
	file_auth_auth_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*RegisterResponse_JwtToken)(nil),
		(*RegisterResponse_ErrorData)(nil),
	}
	file_auth_auth_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*LoginResponse_JwtToken)(nil),
		(*LoginResponse_ErrorData)(nil),
	}
	file_auth_auth_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*RecoverResponse_Sucess)(nil),
		(*RecoverResponse_ErrorData)(nil),
	}
	type x struct{}
